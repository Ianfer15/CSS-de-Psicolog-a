...
boolean guardado = "guardar".equals(accion);
%>
...
<div class="alert alert-success">
    La actividad grupal fue registrada correctamente.
</div>
...
<% } %>
    ...
    <section class="card">
        ...
        <form action="registrar-actividad-grupal.jsp" method="post">
    ...
    <option>Cancelada</option>
            ...
            <div class="acciones-formulario mt-4 acciones-derecha">
               ...
               <a
    href="${pageContext.request.contextPath}/psicologo/actividades-grupales.jsp"
    class="btn btn-secondary"
    onclick="return confirm('¿Está seguro de cancelar el registro?');">
...
<button
    ...
    onclick="return confirm('¿Desea registrar esta actividad?');">
